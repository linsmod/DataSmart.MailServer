...
namespace System.NetworkToolkit.STUN.Message
{
    /// <summary>
        ...
        private void ParseAttribute(byte[] data,ref int offset)
        {
            ...
            */
            ...
            // USERNAME
                ...
                m_UserName = Encoding.UTF8.GetString(data,offset,length);
                offset += length;
            }
            // PASSWORD
            else if(type == AttributeType.Password){
                m_Password = Encoding.UTF8.GetString(data,offset,length);
                offset += length;
            }
            // MESSAGE-INTEGRITY
            ...
            // ERROR-CODE
                ...
                */
                ...
                m_pErrorCode = new STUN_t_ErrorCode(errorCode,Encoding.UTF8.GetString(data,offset + 4,length - 4));
                offset += length;
            }
            // UNKNOWN-ATTRIBUTES
            ...
            // ServerName
                ...
                m_ServerName = Encoding.UTF8.GetString(data,offset,length);
                offset += length;
            }
            // Unknown
            else{
