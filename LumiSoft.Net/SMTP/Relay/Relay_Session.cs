...
namespace System.NetworkToolkit.SMTP.Relay
{
    /// <summary>
    ...
    public class Relay_Session : TCP_Session
    {
        ...
        private void SmtpClient_WriteLog(object sender,WriteLogEventArgs e)
        {
            try{
                ...
                else if(e.LogEntry.EntryType == LogEntryType.RECV){
                ...
                else if(e.LogEntry.EntryType == LogEntryType.INFO){
                ...
                else if(e.LogEntry.EntryType == LogEntryType.SEND){
