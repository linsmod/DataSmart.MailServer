...
namespace System.NetworkToolkit.SMTP.Client
{
    /// <summary>
    ...
    /// // you can use System.NetworkToolkit.Mail classes to compose valid SMTP mail message.
    /// 
    ...
    public class SMTP_Client : TCP_Client
    {
        ...
        public static void QuickSend(System.NetworkToolkit.Mime.Mime message)
        {
            if(message == null){
        ...
        /// <exception cref="ArgumentException">Is raised when any of the method arguments has invalid value.</exception>
        /// <exception cref="SMTP_ClientException">Is raised when SMTP server returns error.</exception>
        public static void QuickSendSmartHost(string localHost,string host,int port,TCP_ClientSecurity security,string userName,string password,Mail_Message message)
        {
            QuickSendSmartHost(localHost,host,port,security == TCP_ClientSecurity.SSL,userName,password,message);
        }
        ...
        {
            QuickSendSmartHost(localHost,host,port,(ssl == true ? TCP_ClientSecurity.SSL : TCP_ClientSecurity.None),userName,password,from,to,message);
        }
        ...
        /// <exception cref="ArgumentException">Is raised when any of the method arguments has invalid value.</exception>
        /// <exception cref="SMTP_ClientException">Is raised when SMTP server returns error.</exception>
        public static void QuickSendSmartHost(string localHost,string host,int port,TCP_ClientSecurity security,string userName,string password,string from,string[] to,Stream message)
        {
            if(host == null){
            ...
            using(SMTP_Client smtp = new SMTP_Client()){
                smtp.Connect(host,port,security == TCP_ClientSecurity.SSL);
                if(security == TCP_ClientSecurity.TLS || (security == TCP_ClientSecurity.UseTlsIfSupported && smtp.SupportsCapability(SMTP_ServiceExtensions.STARTTLS))){
                    smtp.StartTLS();
                }
        ...
        public void Authenticate(string userName,string password)
        {
            ...
            #region AUTH DIGEST-MD5
                ...
                */
                ...
                AUTH_SASL_DigestMD5_Challenge challenge = AUTH_SASL_DigestMD5_Challenge.Parse(Encoding.UTF8.GetString(Convert.FromBase64String(line.Split(' ')[1])));
                ...
                // Send authentication info to server.
				WriteLine(Convert.ToBase64String(Encoding.UTF8.GetBytes(response.ToResponse())));
                ...
                // Check rspauth value.
                if(!string.Equals(Encoding.UTF8.GetString(Convert.FromBase64String(line.Split(' ')[1])),response.ToRspauthResponse(userName,password),StringComparison.InvariantCultureIgnoreCase)){
