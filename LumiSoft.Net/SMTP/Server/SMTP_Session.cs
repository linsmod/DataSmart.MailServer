...
namespace System.NetworkToolkit.SMTP.Server
{
    /// <summary>
                    ...
                    */
                    ...
                    // RFC 5321 4.1.4.
                        ...
                        if(m_pSession.m_pMessageStream == null){
                            m_pSession.m_pMessageStream = new SwapableStream(32000);
                        }                   
...
// REMOVE ME:
        ...
        private bool DATA(string cmdText)
        {
            ...
            */
            ...
            if(m_pMessageStream == null){
                m_pMessageStream = new SwapableStream(32000);
            }
            // RFC 5321.4.4 trace info.
        ...
        private byte[] CreateReceivedHeader()
        {
            ...
            */
            ...
            System.NetworkToolkit.Mail.Mail_h_Received received = new System.NetworkToolkit.Mail.Mail_h_Received(this.EhloHost,Net_Utils.GetLocalHostName(this.LocalHostName),DateTime.Now);
            received.From_TcpInfo = new System.NetworkToolkit.Mail.Mail_t_TcpInfo(this.RemoteEndPoint.Address,null);
            received.Via = "TCP";
