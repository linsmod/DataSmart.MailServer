...
namespace System.NetworkToolkit.Mime.vCard
{
    /// <summary>
            ...
            get{ 
                ...
                if(encoding != null){
                    if(encoding == "quoted-printable"){
                        data = System.Text.Encoding.UTF8.GetString(MIME_Utils.QuotedPrintableDecode(System.Text.Encoding.UTF8.GetBytes(data)));
                    }
                    else if(encoding == "b" || encoding == "base64"){
                        data = System.Text.Encoding.UTF8.GetString(Net_Utils.FromBase64(System.Text.Encoding.UTF8.GetBytes(data)));
                    }
                    else{
                ...
                if(charset != null){
                    data = System.Text.Encoding.GetEncoding(charset).GetString(System.Text.Encoding.UTF8.GetBytes(data));
                }
