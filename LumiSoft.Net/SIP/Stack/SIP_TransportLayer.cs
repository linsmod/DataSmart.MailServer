...
using System.NetworkToolkit.UDP;
using System.NetworkToolkit.TCP;
using System.NetworkToolkit.STUN.Client;

namespace System.NetworkToolkit.SIP.Stack
{
    /// <summary>
    ...
    public class SIP_TransportLayer
    {
        ...
        private TCP_Server<TCP_ServerSession> m_pTCP_Server   = null;
        ...
        internal SIP_TransportLayer(SIP_Stack stack)
        {
            ...
            m_pTCP_Server = new TCP_Server<TCP_ServerSession>();
            m_pTCP_Server.SessionCreated += new EventHandler<TCP_ServerSessionEventArgs<TCP_ServerSession>>(m_pTCP_Server_SessionCreated);
        ...
        #region method m_pTCP_Server_SessionCreated
        ...
        /// <param name="sender">Sender.</param>
        /// <param name="e">Event data.</param>
        private void m_pTCP_Server_SessionCreated(object sender,TCP_ServerSessionEventArgs<TCP_ServerSession> e)
        {
        ...
        public IPBindInfo[] BindInfo
        {
            ...
            set{
                ...
                if(changed){
                    ...
                    m_pTCP_Server.Bindings = tcpListeningPoints.ToArray();

                    // Build possible local TCP/TLS IP addresses.
                    foreach(IPEndPoint ep in m_pTCP_Server.LocalEndPoints){
