	...
	public class MimeUtils
	{
		...
		public static string ParseHeaders(Stream entryStrm)
		{
			...
			*/
			...
			return System.Text.Encoding.UTF8.GetString(msHeaders.ToArray());
		}
		...
		public static string ParseHeaderField(string fieldName,string headers)
		{
			...
			*/
			...
			using(TextReader r = new StreamReader(new MemoryStream(System.Text.Encoding.UTF8.GetBytes(headers)))){
                    ...
                    try{
                        ...
                        if(r.StartsWith("=")){
                            ...
                            if(encoding.ToLower() == "q"){
                                ...
                                decodedWord = c.GetString(Core.Base64Decode(Encoding.UTF8.GetBytes(encodedText)));
                            }
                        }
                    }
                    catch{
