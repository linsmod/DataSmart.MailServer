...
namespace DataSmart.MailServer.Management
{
	public class IMAP_Settings
	{
		...
		internal IMAP_Settings(SystemSettings sysSettings, bool enabled, string greeting, int idleTimeout, int maxConnections, int maxConnectionsPerIP, int maxBadCommands, IPBindInfo[] bindings)
		{
